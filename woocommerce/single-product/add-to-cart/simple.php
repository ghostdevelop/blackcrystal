			...
			<li class="clearfix">
				<div class="additional-product clearfix">
					...
					<div class="additional-product-image">
						<a href="http://blackcrystal.hu/images/0000.jpg" class="zoom">
							<img src="http://blackcrystal.hu/images/0000.jpg" />
						</a>
					</div>
					<div class="button-box">
						<input id="_package_price" class="input-checkbox addiotional-check" type="checkbox" name="_package_price" value="0" />
					</div>
